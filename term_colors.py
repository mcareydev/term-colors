...
'catppuccin_frappe' : {'fg': '#c6d0f5', 'bg': '#303446', 'colors': ['#51576d', '#e78284', '#a6d189', '#e5c890', '#8caaee', '#f4b8e4', '#81c8be', '#b5bfe2', '#626880', '#e78284', '#a6d189', '#e5c890', '#8caaee', '#f4b8e4', '#81c8be', '#a5adce']},
'catppuccin_latte' : {'fg': '#4c4f69', 'bg': '#eff1f5', 'colors': ['#5c5f77', '#d20f39', '#40a02b', '#df8e1d', '#1e66f5', '#ea76cb', '#179299', '#acb0be', '#6c6f85', '#d20f39', '#40a02b', '#df8e1d', '#1e66f5', '#ea76cb', '#179299', '#bcc0cc']},
'catppuccin_macchiato' : {'fg': '#cad3f5', 'bg': '#24273a', 'colors': ['#494d64', '#ed8796', '#a6da95', '#eed49f', '#8aadf4', '#f5bde6', '#8bd5ca', '#b8c0e0', '#5b6078', '#ed8796', '#a6da95', '#eed49f', '#8aadf4', '#f5bde6', '#8bd5ca', '#a5adcb']},
'catppuccin_mocha' : {'fg': '#cdd6f4', 'bg': '#1e1e2e', 'colors': ['#45475a', '#f38ba8', '#a6e3a1', '#f9e2af', '#89b4fa', '#f5c2e7', '#94e2d5', '#bac2de', '#585b70', '#f38ba8', '#a6e3a1', '#f9e2af', '#89b4fa', '#f5c2e7', '#94e2d5', '#a6adc8']},
...
'dracula' : {'fg': '#f8f8f2', 'bg': '#1e1f29', 'colors': ['#000000', '#ff5555', '#50fa7b', '#f1fa8c', '#bd93f9', '#ff79c6', '#8be9fd', '#bbbbbb', '#555555', '#ff5555', '#50fa7b', '#f1fa8c', '#bd93f9', '#ff79c6', '#8be9fd', '#ffffff']},
...
'gruvbox_dark_hard' : {'fg': '#ebdbb2', 'bg': '#1b1b1b', 'colors': ['#1b1b1b', '#cc241d', '#98971a', '#d79921', '#458588', '#b16286', '#689d6a', '#a89984', '#928374', '#fb4934', '#b8bb26', '#fabd2f', '#83a598', '#d3869b', '#8ec07c', '#ebdbb2']},
...
'oceanic_next' : {'fg': '#b3b8c3', 'bg': '#121b21', 'colors': ['#121c21', '#e44754', '#89bd82', '#f7bd51', '#5486c0', '#b77eb8', '#50a5a4', '#ffffff', '#52606b', '#e44754', '#89bd82', '#f7bd51', '#5486c0', '#b77eb8', '#50a5a4', '#ffffff']},
...
'rose_pine' : {'fg': '#e0def4', 'bg': '#191724', 'colors': ['#26233a', '#eb6f92', '#9ccfd8', '#f6c177', '#31748f', '#c4a7e7', '#ebbcba', '#e0def4', '#6e6a86', '#eb6f92', '#9ccfd8', '#f6c177', '#31748f', '#c4a7e7', '#ebbcba', '#e0def4']},
'rose_pine_dawn' : {'fg': '#575279', 'bg': '#faf4ed', 'colors': ['#f2e9e1', '#b4637a', '#56949f', '#ea9d34', '#286983', '#907aa9', '#d7827e', '#575279', '#9893a5', '#b4637a', '#56949f', '#ea9d34', '#286983', '#907aa9', '#d7827e', '#575279']},
'rose_pine_moon' : {'fg': '#e0def4', 'bg': '#232136', 'colors': ['#393552', '#eb6f92', '#9ccfd8', '#f6c177', '#3e8fb0', '#c4a7e7', '#ea9a97', '#e0def4', '#6e6a86', '#eb6f92', '#9ccfd8', '#f6c177', '#3e8fb0', '#c4a7e7', '#ea9a97', '#e0def4']},
